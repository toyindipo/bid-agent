...
object BiddingAgentApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rootBehavior = Behaviors.setup[Nothing] { context =>
      val biddingAgentActor = context.spawn(BiddingAgent(BiddingAgent.sampleCampaigns()), "BiddingAgentActor")
    ...
    val system = ActorSystem[Nothing](rootBehavior, "BiddingAgentHttpServer")
